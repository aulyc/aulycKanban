...
const zh = {
	...
	'archive.delete.filtered': '删除当前筛选结果（{count}）',
	'archive.delete.selectAll': '全选当前结果',
	'archive.delete.selectTask': '选择任务',
	'archive.delete.more': '更多删除操作',
...
const en: Record<I18nKey, string> = {
	...
	'archive.delete.filtered': 'Delete filtered results ({count})',
	'archive.delete.selectAll': 'Select current results',
	'archive.delete.selectTask': 'Select task',
	'archive.delete.more': 'More delete actions',
